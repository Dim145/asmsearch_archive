...
{
    var elements = [$("#baseURL"), $("#searchURL"), $("#iconURL"), $("#siteTitle"), $("#type"), $("#cheminElt"), $("#idDoc"), $("#cheminRes")];
    ...
    $("#site").click(function (event)
    {
        ...
        while (target[0] != undefined && target[0].id != "site" && target[0].localName != "body")
        {
            ...
            {
                let tmp = "/" + target[0].localName;
                let classString = target.attr('class');
    ...
    $("#site2").click(function (event)
    {
        ...
        while (target[0] != undefined && target[0].id != "site2" && target[0].localName != "body")
        {
            if (target[0].localName != undefined)
            {
                let tmp = "/" + target[0].localName;
    ...
    function changeDialogSite(url)
    {
        ...
        $.post(urlBase + "GetHTMLSite?url=" + encodeURIComponent(url + (url.endsWith("=") ? tabSearch[tmp] : "")), postValues, function (response)
        {
            ...
            $("#dataSearch2").text(tabSearch[tmp]);
        }).fail(function ()
        {
            SwalFire({
    ...
    function validerForm()
    {
        var site = {
            ...
            cheminToNbResult: elements[7].val()
