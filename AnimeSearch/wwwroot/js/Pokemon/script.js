...
var Resources = {
    pokeball: '/ressources/images/pkmngo-pokeball.png',
    pokeballActive: '/ressources/images/pkmngo-pokeballactive.png',
    pokeballClosed: '/ressources/images/pkmngo-pokeballclosed.png'
};
...
function animateCaptureState() {
    ...
    setTimeout(function() {
        ...
        if (seed < Math.floor(successRate)) {
            ...
            captureStatus.innerHTML = "Vous avez attrapé Dialga!"
            makeItRainConfetti();
            ...
            var captureStatus = document.getElementById('capture-status');
            captureStatus.innerHTML = "Dialga s'est échappé!"
            captureStatus.classList.toggle('hidden');
