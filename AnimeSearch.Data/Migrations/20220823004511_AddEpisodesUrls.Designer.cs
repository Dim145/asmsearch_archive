...
namespace AnimeSearch.Data.Migrations
{
    ...
    [Migration("20220823004511_AddEpisodesUrls")]
    partial class AddEpisodesUrls
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnimeSearch.Data.Models.Domains", b =>
                {
            ...
            modelBuilder.Entity("AnimeSearch.Data.Models.EpisodesUrls", b =>
                {
                    ...
                    b.HasKey("ApiId", "SearchId", "SeasonNumber", "EpisodeNumber", "Url");

                    b.ToTable("EpisodesUrls");
                });

            modelBuilder.Entity("AnimeSearch.Data.Models.Genre", b =>
                {
                    b.Property<int>("ApiId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AnimeSearch.Data.Models.Sites", b =>
                {
                    ...
                    b.Property<string>("CheminToNbResult")
                        .HasColumnType("nvarchar(max)")
            ...
            modelBuilder.Entity("AnimeSearch.Data.Models.EpisodesUrls", b =>
                {
                    b.HasOne("AnimeSearch.Data.Models.ApiObject", "Api")
                        .WithMany()
                        .HasForeignKey("ApiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
